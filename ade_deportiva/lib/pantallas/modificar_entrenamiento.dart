...
class ModificarEntrenamiento extends StatefulWidget {
  const ModificarEntrenamiento({super.key});

  @override
  State<ModificarEntrenamiento> createState() => _ModificarEntrenamientoState();
}

class _ModificarEntrenamientoState extends State<ModificarEntrenamiento> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(content: Text("Entrenamiento modificado")),
                    );
                  },
                  child: const Text(
                    "Confirmar",
              ...
              /// BOTÓN CANCELAR (más pequeño, gris claro con contorno)
              SizedBox(
                width: 150,
